...
export default function PropertyDetail() {
  ...
  useSeoMetadata({
    title: `${property.title} | ERP Group Company`,
    description: `${property.title} for sale in ${property.location}. Price ${priceText}. Contact ERP Group Company.`,
    keywords: `${property.title}, ${property.location}, Chennai real estate, property for sale`,
              ...
              <div className="mt-3 flex flex-wrap items-center justify-between gap-4">
                <div>
                  <p className="text-xl font-semibold text-slate-900">
                    {property.agentName || "ERP Group Company"}
                  </p>
                  <p className="mt-1 text-sm text-gray-500">
                    {property.agentPhone || property.contactNumber || "8939427799"}
                  </p>
                </div>
                {property.agentSlug ? (
                  <Link
