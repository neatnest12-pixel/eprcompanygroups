export default function Footer() {
  return (
    <footer className="mt-20 border-t border-white/10 bg-[#0b5d3b]/85 text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 md:grid-cols-3">
        <div>
          ...
          <p className="mt-4 text-sm text-white/70">
            Premium real estate expertise with verified listings, strategic marketing,
            and growth-driven investments.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-white/70">Chennai, Tamil Nadu</p>
